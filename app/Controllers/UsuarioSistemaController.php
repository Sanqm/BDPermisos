...
class UsuarioSistemaController extends \Com\Daw2\Core\BaseController {
    ...
    function mostrarEdit(int $id) : void{
     ...
     function mostrarDelete(int $id) : void{
        $data = [];
        $data['titulo'] = 'Borrado de Usuarios';
        $data['seccion'] = '/usuarios-sistema/delete';
        $data['tituloDiv'] = 'Usuario Borrado';
    ...
    function deleteUsuarioSistema(int $id){
        $model = new \Com\Daw2\Models\UsuarioSistemaModel;
        if(($model->deleteUsuarioSistema($id))){
           header('location: /usuarios-sistema');
      }
//        else{
//            $errores['nombre'] = "No se ha podido borrar el usuario";
//        }
//        
//         $data['titulo'] = 'Borrar usuario';
//        $data['seccion'] = '/usuarios-sistema/delete';
//        $data['tituloDiv'] = 'Borrar Usuario';
//        $data['input'] = filter_var_array($_POST, FILTER_SANITIZE_SPECIAL_CHARS);
//        
//        $rolModel = new \Com\Daw2\Models\AuxRolModel();
//        $data['roles'] = $rolModel->getAll();
